...
{
    public class FlierRanged : MonoBehaviour
    {
        ...
        protected void BotInitialization()
        {
            ...
            //Func<bool> InReach() => () => arms.CheckReachToTarget(currentTarget.position);
            //Func<bool> NotInReach() => () => !arms.CheckReachToTarget(currentTarget.position);
        }
